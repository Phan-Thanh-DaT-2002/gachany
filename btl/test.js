...
$(document).ready/*kiểm tra nếu tài liệu sẵn sàng thì chạy funtion*/(function(){
	setInterval/*chạy funtion mỗi 500ms giây*/(function(){
		var screenHeight = $(document).height();//chiều cao của tài liệu != $(window).height() là chiều cao của toàn bộ khung hình cửa sổ
		var screenWidth = $(document).width();//chiều rộng của tài liệu != $(window).with() là chiều rộng của toàn bộ khung hình cửa sổ
		...
		var snow = document.createElement('span');// tạo một phần tử span
